    ...
    def error(self, msg, to_stderr=False, is_exception=False):
        if msg:
            ...
            msg += "\nIn case you have troubles running our tool, " \
                   "you can post an issue on https://github.com/ablab/centromere-architect/issues " \
                   "or write to t.dvorkina@spbu.ru"
